function axialAnalysis(f_AVG_video, maskArtery, maskVein, maskNeighbors)
    % Initial Setup
    ...
    % Create section mask
    x_c = ToolBox.Cache.list.xy_barycenter(1) / numX;
    y_c = ToolBox.Cache.list.xy_barycenter(2) / numY;
