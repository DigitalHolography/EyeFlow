...
exportgraphics(gca, fullfile(ToolBox.path_png, 'bloodFlowVelocity', sprintf("%s_colorbarVelocity%s.png", ToolBox.folder_name, name)))
exportgraphics(gca, fullfile(ToolBox.path_eps, 'bloodFlowVelocity', sprintf("%s_colorbarVelocity%s.eps", ToolBox.folder_name, name)))
end
