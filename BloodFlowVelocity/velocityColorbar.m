...
exportgraphics(gca, fullfile(ToolBox.path_png, 'global', sprintf("%s_colorbarVelocity%s.png", ToolBox.folder_name, name)))
exportgraphics(gca, fullfile(ToolBox.path_eps, 'global', sprintf("%s_colorbarVelocity%s.eps", ToolBox.folder_name, name)))
end
