...
ToolBox.Output.add('TransFunctionModLog10FlowRate', fftshift(abs(log10(F_TRANS))), 'log10', h5path = '/SpectralAnalysis/ArteryVein/TransferFunction/ModLog10');
ToolBox.Output.add('TransFunctionPhaseDegreesFlowRate', fftshift(180 / pi * angle((F_TRANS))), 'deg', h5path = '/SpectralAnalysis/ArteryVein/TransferFunction/PhaseDegrees');
