...
parfor cIdx = 1:numCircles
    ...
    % Export plot
    exportgraphics(gca, fullfile(path_png, 'local', 'vesselSegmentImages', 'lumenDiameter', ...
        sprintf("%s_circle_%d_crossSectionWidth_%s.png", main_folder, cIdx, name)));
    exportgraphics(gca, fullfile(path_eps, 'local', 'vesselSegmentImages', 'lumenDiameter', ...
    ...
    % Export plot
    exportgraphics(gca, fullfile(path_png, 'local', 'vesselSegmentImages', 'vesselSegmentId', ...
        sprintf("%s_circle_%d_Numerotation%sImage.png", main_folder, cIdx, name)));
    exportgraphics(gca, fullfile(path_eps, 'local', 'vesselSegmentImages', 'vesselSegmentId', ...
    ...
    % Export plot
    exportgraphics(gca, fullfile(path_png, 'local', 'vesselSegmentImages', 'bloodVolumeRate', ...
        sprintf("%s_circle_%d_BVR_%s.png", main_folder, cIdx, name)));
    exportgraphics(gca, fullfile(path_eps, 'local', 'vesselSegmentImages', 'bloodVolumeRate', ...
    ...
    % Export plot
    exportgraphics(gca, fullfile(path_png, 'local', 'vesselSegmentImages', 'velocity', ...
        sprintf("%s_circle_%d_velocity%sImage.png", main_folder, cIdx, name)));
    exportgraphics(gca, fullfile(path_eps, 'local', 'vesselSegmentImages', 'velocity', ...
