...
if ~isfolder(fullfile(ToolBox.path_png, 'local'))
    mkdir(ToolBox.path_png, 'local')
    mkdir(ToolBox.path_eps, 'local')
end
...
imwrite(labeledVessels + 1, cmap, fullfile(ToolBox.path_png, 'local', sprintf("%s_labeledVessels_%s.png", ToolBox.folder_name, vesselName)))
...
if ~isfolder(fullfile(ToolBox.path_png, 'local', 'vesselSegmentLumen'))
    mkdir(fullfile(ToolBox.path_png, 'local'), 'vesselSegmentLumen')
end

if ~isfolder(fullfile(ToolBox.path_png, 'local', 'velocityProfiles'))
    mkdir(fullfile(ToolBox.path_png, 'local'), 'velocityProfiles')
    mkdir(fullfile(ToolBox.path_eps, 'local'), 'velocityProfiles')
end
...
imwrite(rejected_mask, fullfile(ToolBox.path_png, 'local', sprintf("%s_rejected_masks_%s.png", ToolBox.folder_name, vesselName)))
